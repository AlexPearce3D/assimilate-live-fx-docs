...
* [**Unreal Engine**](unreal-engine/README.md)/Unity/Notch compatibility
* Every major Video Codec including ProRes, Notch LC, h.264
* [**Projection-Mapping**](led-workflow/README.md)
* LED Wall mapping
* [**Green Screen**](green-screen-workflow/README.md) compositing
* Image-Based [**Lighting**](lighting/README.md)
...
If you're just discovering Live FX, we recommend jumping straight into the [Quickstart Example Projects](quickstart-example-projects/README.md)!
...
![](assets/LiveFXDocumentation_QR_Black.png)<br>
