...
4. Under Settings>Monitors, set the Dual Head to   
   Rec 709 (or 2020 if you're going to 2020)  
   Set to PQ or HLG (Depending on your workflow)   
   ![](<../../assets/image (15).png>)<br>
5. In your LED Processor, you need to override the input signal and force it to do PQ or HLG (depending on your workflow and depending on what you set in Live FX). <br>
