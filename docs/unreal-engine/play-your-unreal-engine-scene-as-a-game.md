...
If you are using an LED workflow, you will want to run your Unreal Engine project as a game or [Package your project to a stand-alone .exe file. ](how-to-package-an-unreal-engine-project-for-live-fx/README.md)
