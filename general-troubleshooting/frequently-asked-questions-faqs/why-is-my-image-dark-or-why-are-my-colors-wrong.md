...
<figure><img src="../../.gitbook/assets/image (272).png" alt="" width="375"><figcaption><p>Scene Linear does not look correct without an adjusment</p></figcaption></figure>
...
1.  Add a new layer and simply change the Gamma Master to 2.2 (or whatever your monitor is closest to). <br>
    ...
    <figure><img src="../../.gitbook/assets/image (271).png" alt=""><figcaption><p>Master Gamma changed to 2.2</p></figcaption></figure>
