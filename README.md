...
* 16k+ Resolution [**Video Playback**](docs/quickstart-example-projects/simple-video-playback.md)
* [**Unreal Engine**](docs/unreal-engine/)/Unity/Notch compatibility
* Every major Video Codec including ProRes, Notch LC, h.264
* [**Projection-Mapping**](docs/led-workflow/)
* LED Wall mapping
* [**Green Screen**](docs/green-screen-workflow/) compositing
* Image-Based [**Lighting**](docs/lighting/)
...
If you're just discovering Live FX, we recommend jumping straight into the [Quickstart Example Projects](docs/quickstart-example-projects/)!
...
![](.gitbook/assets/LiveFXDocumentation_QR_Black.png)<br>
