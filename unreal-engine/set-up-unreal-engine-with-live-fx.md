...
Search for Live Link Preset, select the “Default Live Link Preset”, and select the newly created preset.<br>
...
1. Go to the Add Menu <img src="../.gitbook/assets/image (254).png" alt="" data-size="line">
2. Add a **`Basic>Actor`**
...
4. Go to the Add Menu <img src="../.gitbook/assets/image (255).png" alt="" data-size="line">
